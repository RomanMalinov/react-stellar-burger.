    ...
    <main className={`${styles.main} pl-10`}>
      <nav className={styles.navLinks}>
        <p className="text text_type_main-medium pt-4 pb-4">
          <Link
            to={"/profile"}
            className={`${styles.link}  ${isProfileActive ? "text_color_primary" : "text_color_inactive"
              }`}
          >
            Профиль
          </Link>
        ...
        <p className="text text_type_main-medium pt-4 pb-4 ">
          <Link
            to={"/profile/orders"}
            className={`${styles.link}  ${isOrderActive ? "text_color_primary" : "text_color_inactive"
              }`}
          >
            История заказов
          </Link>
